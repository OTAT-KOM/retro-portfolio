...
<html>
<head>
    <title>Manage Pictures - OTAT Admin</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <a href="edit_picture_item.php" class="btn btn-add">+ Add New Picture</a>
        </div>
                ...
                <?php foreach ($items as $index => $item): ?>
                    <div class="item-row">
                        ...
                        <div class="item-actions">
                            <a href="edit_picture_item.php?index=<?php echo $index; ?>" class="btn btn-edit">Edit</a>
